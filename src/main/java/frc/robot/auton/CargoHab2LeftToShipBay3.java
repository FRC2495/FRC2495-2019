...
public class CargoHab2LeftToShipBay3 extends CommandGroup {
	/**
	 * Add your docs here.
	 */
	public CargoHab2LeftToShipBay3(String autonOption) {
		// Add Commands here:
		...
		//Move straight from Hab2 LS to Bay 1
		...
		addSequential(new DrivetrainMoveDistanceHighSpeed((AutonConstants.HAB2_CARGOSHIP_BAY3_TOTAL_DISTANCE-AutonConstants.HAB2_CARGOSHIP_DISTANCE_BEFORE_TURN)/Math.cos(Math.toRadians(AutonConstants.HAB_TO_BAY_ANGLE))));
