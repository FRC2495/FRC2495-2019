...
public class CargoHab2LeftToShipBay3 extends CommandGroup {
	...
	public CargoHab2LeftToShipBay3() {
		...
		addSequential(new DrivetrainMoveDistance((AutonConstants.HAB2_CARGOSHIP_BAY3_TOTAL_DISTANCE-AutonConstants.HAB2_CARGOSHIP_DISTANCE_BEFORE_TURN)/Math.cos(Math.toRadians(AutonConstants.HAB_TO_BAY_ANGLE))));
