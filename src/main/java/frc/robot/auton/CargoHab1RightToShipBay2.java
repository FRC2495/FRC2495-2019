...
public class CargoHab1RightToShipBay2 extends CommandGroup {
	...
	public CargoHab1RightToShipBay2() {
		...
		addSequential(new DrivetrainMoveDistanceHighSpeed(AutonConstants.HAB1_CARGOSHIP_BAY2_TOTAL_DISTANCE-AutonConstants.HAB1_CARGOSHIP_DISTANCE_BEFORE_TURN));
