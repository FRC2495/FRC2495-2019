...
public class CargoHab1RightToShipBay1 extends CommandGroup {
	...
	public CargoHab1RightToShipBay1() {
		...
		addSequential(new DrivetrainMoveDistanceHighSpeed(AutonConstants.HAB1_CARGOSHIP_BAY1_TOTAL_DISTANCE-AutonConstants.HAB1_CARGOSHIP_DISTANCE_BEFORE_TURN));
