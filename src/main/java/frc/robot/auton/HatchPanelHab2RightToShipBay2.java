...
public class HatchPanelHab2RightToShipBay2 extends CommandGroup {
	/**
	 * Add your docs here.
	 */
	public HatchPanelHab2RightToShipBay2(String autonOption) {
		// Add Commands here:
		...
		addSequential(new DrivetrainMoveDistanceHighSpeed((AutonConstants.HAB2_CARGOSHIP_BAY2_TOTAL_DISTANCE-AutonConstants.HAB2_CARGOSHIP_DISTANCE_BEFORE_TURN)/Math.cos(Math.toRadians(AutonConstants.HAB_TO_BAY_ANGLE))));
		...
		run  = AutonConstants.HAB1_CARGOSHIP_BAY2_TOTAL_DISTANCE;
