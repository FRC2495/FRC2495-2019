...
public class HatchPanelHab2RightToShipBay2 extends CommandGroup {
	...
	public HatchPanelHab2RightToShipBay2() {
		...
		addSequential(new DrivetrainMoveDistanceHighSpeed(AutonConstants.HAB2_CARGOSHIP_BAY1_TOTAL_DISTANCE-AutonConstants.HAB1_CARGOSHIP_DISTANCE_BEFORE_TURN));
