...
public class CargoHab1RightToShipBay3 extends CommandGroup {
	...
	public CargoHab1RightToShipBay3() {
		...
		addSequential(new DrivetrainMoveDistanceHighSpeed(AutonConstants.HAB1_CARGOSHIP_BAY3_TOTAL_DISTANCE-AutonConstants.HAB1_CARGOSHIP_DISTANCE_BEFORE_TURN));
