...
public class Sucker extends Subsystem implements ISucker {
	...
	public Sucker() {
		...
		inOut = new DoubleSolenoid(Ports.CAN.PCM, Ports.PCM.SUCKER_INHALE, Ports.PCM.SUCKER_EXHALE); // make sure ports are properly sets in Ports.java	
	}
